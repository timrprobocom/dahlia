...
bracket( canvas, 'l', 36, 36, teams, "Beaverton" )
bracket( canvas, 'r', pagesize[0]/2-40, 36, teams, "Gresham" )
canvas.saveState()
...
bracket( canvas, 'l', 36, 36, teams, "Tigard" )
bracket( canvas, 'r', pagesize[0]/2-40, 36, teams, "Clackamas" )
canvas.saveState()
canvas.translate( 36+columns[6], 36+UNITH*6 )
drawteam( canvas, None )
canvas.translate( 0, UNITH*2 )
